...
// SEED COURSES IF EMPTY - 30+ PROFESSIONAL CERTIFICATIONS
...
if (courses.length === 0 || !courses.length) {
  ...
  const defaultCourses = [
    ...
    // ==================== SUPPORT & SERVICE CERTIFICATIONS ====================
  ...
  console.log(`📚 Found ${courses.length || courses.courses?.length || 0} existing courses`);
}
